...
use crate::compiler::manifest::{FunctionOperandKind, FunctionOptionValueKind};
use crate::compiler::semantic::SourceSpan;
...
impl CompileError {
    pub(crate) fn primary_source_id(&self) -> Option<crate::compiler::semantic::SourceId> {
        match self {
            Self::DuplicateMessageId {
                second_origin,
                first_origin,
