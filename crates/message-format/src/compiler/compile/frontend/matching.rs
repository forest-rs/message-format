...
pub(super) struct MatchArm<'a> {
    ...
    pub(super) pattern: crate::compiler::syntax::ast::PatternNode<'a>,
}
...
pub(super) struct ParsedMatchDeclaration<'a> {
    ...
    pub(super) duplicate_keys: Vec<crate::compiler::syntax::semantic::VariantKeyOccurrence>,
}

pub(super) fn lower_match_declaration_prelude(
    prelude: crate::compiler::syntax::semantic::MatchDeclarationPrelude<'_>,
