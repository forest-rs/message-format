...
//!
//! For a detailed cross-module error model, see
...
//!
//! ```rust
//! use message_format::compiler::{CatalogBuilder, SourceKind, SourceSpan};
//! use message_format::compiler::semantic::{Message, SelectExpr, SelectorExpr, Part};
//!
...
//!
//! ```rust
//! use message_format::compiler::{CompileOptions, ResourceInput, compile_resources};
//!
//! let resources = ResourceInput::new("app.toml", message_format::compiler::SourceKind::Other("resource-toml".into()))
...
//! [`crate::runtime::schema`], which is also used by the runtime
//! verifier and VM.
