...
//! [`crate::compiler::syntax`]: rather than parse an MF2 pattern into decoded text,
//! they take arbitrary text and produce MF2 source that round-trips back
//! to that same text.

use alloc::{borrow::Cow, string::String};

use crate::compiler::syntax::ident::is_ignorable_char;
...
mod tests {
    use super::*;
    use crate::compiler::test_support::format_simple_main;
